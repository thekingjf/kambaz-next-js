import { FormLabel, FormControl, FormSelect, FormCheck, InputGroup, Col, Row } from "react-bootstrap";
...
export default function BootstrapForms() {
    return (
        ...
        <h3>Switches</h3>
        <FormCheck type="switch"    defaultChecked={false}
                    label="Unchecked switch checkbox input"/>
        <FormCheck type="switch"  defaultChecked={true}
                    label="Checked switch checkbox input"/>
        <FormCheck type="switch"    defaultChecked={false} disabled
                    label="Unchecked disabled switch checkbox input"/>
        <FormCheck type="switch"  defaultChecked={true} disabled 
